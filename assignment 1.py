...
Original file is located at
    https://colab.research.google.com/drive/1Vi0q7GJOTbNZcMsJrb_3SxWItfpr4b0z
"""

def register():
    db = open("/content/sample_data/User_register (1).txt", "r")
    ...
    file = open("/content/sample_data/User_register (1).txt", "a")
    file.write(a + "," + b + "\n")
    file.close()
    login()
...
def login():
    ...
    if X in d:
        ...
        Y=Y.strip()
        file1=open("/content/sample_data/User_register (1).txt","r").readlines()
        for x in file1:
            x=x.strip()
            info=x.split(",")
            if X==info[0] and Y==info[1]:
                ...
                if F == "Y":
                    ...
                    file = open("/content/sample_data/User_register (1).txt", "w")
                    file.write(X + "," + b + "\n")
                    file.close()
