...
Original file is located at
    https://colab.research.google.com/drive/1qgGaThfZDJQA86vwC2D2ifWOopaXBBAz
"""

def register():
    db = open("/content/sample_data/access_register.txt", "r")
    ...
    file = open("/content/sample_data/access_register.txt", "a")
    file.write(a + "," + b + "\n")
    file.close()
    login()
...
def login():
    ...
    if X in d:
        ...
        Y=Y.strip()
        file1=open("/content/sample_data/access_register.txt","r").readlines()
        for x in file1:
            x=x.strip()
            info=x.split(",")
